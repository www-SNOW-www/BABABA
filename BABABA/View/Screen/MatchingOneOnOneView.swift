...
struct MatchingOneOnOneView: View {
    var onMatch: (Match) -> ()
    // Game Properties
    ...
    @State private var matchPlayStyleText: String = "One-ON-One"
...
struct MatchingOneOnOneView_Previews: PreviewProvider {
